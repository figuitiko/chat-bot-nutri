...
const templates = [
  ...
  },
  {
    ...
    body: "💡 ¿Debo banarme todos los dias antes de comenzar mis labores?\nA) SI\nB) NO",
    kind: TemplateKind.TWILIO_CONTENT_TEMPLATE,
    twilioContentSid: null,
  },
  {
...
const flowDefinitions: SeedFlow[] = [
  {
    ...
    description: "Onboarding y recorrido completo del curso Nutri actualizado desde el documento fuente.",
    ...
    transitions: [
      exactTransition("training_welcome_intro", "si vamos", "training_materials_intro", 1),
      keywordTransition("training_welcome_intro", "si", "training_materials_intro", 2),
      keywordTransition("training_welcome_intro", "vamos", "training_materials_intro", 3),
      fallbackTransition("training_welcome_intro"),

      exactTransition("training_materials_intro", "vamos", "training_module_1_intro", 1),
      fallbackTransition("training_materials_intro"),

      exactTransition("training_module_1_intro", "vamos", "training_cafeteria_experience", 1),
      fallbackTransition("training_module_1_intro"),

      exactTransition("training_cafeteria_experience", "1", "training_eta_audio", 1, "Menos de 6 meses"),
      containsTransition("training_cafeteria_experience", "menos de 6 meses", "training_eta_audio", 2, "Menos de 6 meses"),
      exactTransition("training_cafeteria_experience", "2", "training_eta_audio", 3, "Entre 6 meses y 1 ano"),
      containsTransition("training_cafeteria_experience", "entre 6 meses y 1 ano", "training_eta_audio", 4, "Entre 6 meses y 1 ano"),
      exactTransition("training_cafeteria_experience", "3", "training_eta_audio", 5, "Entre 1 y 2 anos"),
      containsTransition("training_cafeteria_experience", "entre 1 y 2 anos", "training_eta_audio", 6, "Entre 1 y 2 anos"),
      exactTransition("training_cafeteria_experience", "4", "training_eta_audio", 7, "Mas de 2 anos"),
      containsTransition("training_cafeteria_experience", "mas de 2 anos", "training_eta_audio", 8, "Mas de 2 anos"),
      exactTransition("training_cafeteria_experience", "si", "training_eta_audio", 9),
      fallbackTransition("training_cafeteria_experience"),

      exactTransition("training_eta_audio", "vamos", "training_eta_activity", 1),
      fallbackTransition("training_eta_audio"),

      exactTransition("training_eta_activity", "continuar", "training_food_handling_audio", 1),
      fallbackTransition("training_eta_activity"),

      exactTransition("training_food_handling_audio", "continuemos", "training_regulation_intro", 1),
      containsTransition("training_food_handling_audio", "continuemos", "training_regulation_intro", 2),
      fallbackTransition("training_food_handling_audio"),

      exactTransition("training_regulation_intro", "continuar", "training_hygiene_summary", 1),
      fallbackTransition("training_regulation_intro"),

      exactTransition("training_hygiene_summary", "vamos", "training_cleaning_audio", 1),
      fallbackTransition("training_hygiene_summary"),

      exactTransition("training_cleaning_audio", "vamos", "training_drying_video", 1),
      fallbackTransition("training_cleaning_audio"),

      exactTransition("training_drying_video", "continuar", "training_drying_quiz", 1),
      fallbackTransition("training_drying_video"),

      exactTransition("training_drying_quiz", "falso", "training_drying_quiz_correct", 1, "Falso"),
      exactTransition("training_drying_quiz", "verdadero", "training_drying_quiz_incorrect", 2, "Verdadero"),
      fallbackTransition("training_drying_quiz"),

      exactTransition("training_drying_quiz_correct", "vamos", "training_cross_contamination_audio", 1),
      fallbackTransition("training_drying_quiz_correct"),

      exactTransition("training_drying_quiz_incorrect", "vamos", "training_cross_contamination_audio", 1),
      fallbackTransition("training_drying_quiz_incorrect"),

      exactTransition("training_cross_contamination_audio", "vamos", "training_temperature_control", 1),
      fallbackTransition("training_cross_contamination_audio"),

      exactTransition("training_temperature_control", "continuar", "training_evaluation_intro", 1),
      fallbackTransition("training_temperature_control"),

      exactTransition("training_evaluation_intro", "test", "training_evaluation_q1", 1),
      exactTransition("training_evaluation_intro", "vamos", "training_evaluation_q1", 2),
      fallbackTransition("training_evaluation_intro"),

      exactTransition("training_evaluation_q1", "a", "training_evaluation_q2", 1, "A"),
      exactTransition("training_evaluation_q1", "b", "training_evaluation_q2", 2, "B"),
      exactTransition("training_evaluation_q1", "c", "training_evaluation_q2", 3, "C"),
      fallbackTransition("training_evaluation_q1"),

      exactTransition("training_evaluation_q2", "a", "training_evaluation_q3", 1, "A"),
      exactTransition("training_evaluation_q2", "b", "training_evaluation_q3", 2, "B"),
      exactTransition("training_evaluation_q2", "c", "training_evaluation_q3", 3, "C"),
      fallbackTransition("training_evaluation_q2"),

      exactTransition("training_evaluation_q3", "a", "training_evaluation_q4", 1, "A"),
      exactTransition("training_evaluation_q3", "b", "training_evaluation_q4", 2, "B"),
      exactTransition("training_evaluation_q3", "c", "training_evaluation_q4", 3, "C"),
      fallbackTransition("training_evaluation_q3"),

      exactTransition("training_evaluation_q4", "a", "training_evaluation_q5", 1, "A"),
      exactTransition("training_evaluation_q4", "b", "training_evaluation_q5", 2, "B"),
      exactTransition("training_evaluation_q4", "c", "training_evaluation_q5", 3, "C"),
      fallbackTransition("training_evaluation_q4"),

      exactTransition("training_evaluation_q5", "a", "training_evaluation_q6", 1, "A"),
      exactTransition("training_evaluation_q5", "b", "training_evaluation_q6", 2, "B"),
      exactTransition("training_evaluation_q5", "c", "training_evaluation_q6", 3, "C"),
      fallbackTransition("training_evaluation_q5"),

      exactTransition("training_evaluation_q6", "a", "training_evaluation_result", 1, "A"),
      exactTransition("training_evaluation_q6", "b", "training_evaluation_result", 2, "B"),
      exactTransition("training_evaluation_q6", "c", "training_evaluation_result", 3, "C"),
      fallbackTransition("training_evaluation_q6"),

      exactTransition("training_evaluation_result", "continuar", "training_module_2_intro", 1),
      fallbackTransition("training_evaluation_result"),

      exactTransition("training_module_2_intro", "vamos", "training_module_2_rules_video", 1),
      fallbackTransition("training_module_2_intro"),

      exactTransition("training_module_2_rules_video", "continuar", "training_module_2_quiz_intro", 1),
      fallbackTransition("training_module_2_rules_video"),

      exactTransition("training_module_2_quiz_intro", "vamos", "training_module_2_q1", 1),
      fallbackTransition("training_module_2_quiz_intro"),

      exactTransition("training_module_2_q1", "a", "training_module_2_q2", 1, "SI"),
      exactTransition("training_module_2_q1", "b", "training_module_2_q2", 2, "NO"),
      fallbackTransition("training_module_2_q1"),

      exactTransition("training_module_2_q2", "a", "training_module_2_q3", 1, "SI"),
      exactTransition("training_module_2_q2", "b", "training_module_2_q3", 2, "NO"),
      fallbackTransition("training_module_2_q2"),

      exactTransition("training_module_2_q3", "a", "training_module_2_q4", 1, "SI"),
      exactTransition("training_module_2_q3", "b", "training_module_2_q4", 2, "NO"),
      fallbackTransition("training_module_2_q3"),

      exactTransition("training_module_2_q4", "a", "training_module_2_q5", 1, "SI"),
      exactTransition("training_module_2_q4", "b", "training_module_2_q5", 2, "NO"),
      fallbackTransition("training_module_2_q4"),

      exactTransition("training_module_2_q5", "a", "training_module_2_q6", 1, "SI"),
      exactTransition("training_module_2_q5", "b", "training_module_2_q6", 2, "NO"),
      fallbackTransition("training_module_2_q5"),

      exactTransition("training_module_2_q6", "a", "training_module_2_q7", 1, "SI"),
      exactTransition("training_module_2_q6", "b", "training_module_2_q7", 2, "NO"),
      fallbackTransition("training_module_2_q6"),

      exactTransition("training_module_2_q7", "a", "training_module_2_q8", 1, "SI"),
      exactTransition("training_module_2_q7", "b", "training_module_2_q8", 2, "NO"),
      fallbackTransition("training_module_2_q7"),

      exactTransition("training_module_2_q8", "a", "training_module_2_quiz_result", 1, "SI"),
      exactTransition("training_module_2_q8", "b", "training_module_2_quiz_result", 2, "NO"),
      fallbackTransition("training_module_2_q8"),

      exactTransition("training_module_2_quiz_result", "vamos", "training_module_2_handwashing_video", 1),
      fallbackTransition("training_module_2_quiz_result"),

      exactTransition("training_module_2_handwashing_video", "continuar", "training_module_2_handwashing_quiz", 1),
      fallbackTransition("training_module_2_handwashing_video"),

      exactTransition("training_module_2_handwashing_quiz", "1", "training_module_2_waste_infographic", 1, "Solo una vez al dia"),
      exactTransition("training_module_2_handwashing_quiz", "2", "training_module_2_waste_infographic", 2, "Cada vez que sea necesario"),
      exactTransition("training_module_2_handwashing_quiz", "3", "training_module_2_waste_infographic", 3, "Solo al terminar la jornada"),
      exactTransition("training_module_2_handwashing_quiz", "4", "training_module_2_waste_infographic", 4, "Cuando tenga tiempo"),
      fallbackTransition("training_module_2_handwashing_quiz"),

      exactTransition("training_module_2_waste_infographic", "continuemos", "training_module_2_peps_audio", 1),
      fallbackTransition("training_module_2_waste_infographic"),

      exactTransition("training_module_2_peps_audio", "vamos", "training_module_2_storage_video", 1),
      fallbackTransition("training_module_2_peps_audio"),

      exactTransition("training_module_2_storage_video", "continuar", "training_module_2_pests_infographic", 1),
      fallbackTransition("training_module_2_storage_video"),

      exactTransition("training_module_2_pests_infographic", "continuemos", "training_module_2_fruit_wash_infographic", 1),
      fallbackTransition("training_module_2_pests_infographic"),

      exactTransition("training_module_2_fruit_wash_infographic", "vamos", "training_module_3_intro", 1),
      fallbackTransition("training_module_2_fruit_wash_infographic"),

      exactTransition("training_module_3_intro", "continuar", "training_module_3_manual", 1),
      fallbackTransition("training_module_3_intro"),

      exactTransition("training_module_3_manual", "continuar", "training_module_3_healthy_eating", 1),
      fallbackTransition("training_module_3_manual"),

      exactTransition("training_module_3_healthy_eating", "vamos", "training_module_3_audio", 1),
      fallbackTransition("training_module_3_healthy_eating"),

      exactTransition("training_module_3_audio", "continuemos", "training_module_3_minutario", 1),
      fallbackTransition("training_module_3_audio"),

      exactTransition("training_module_3_minutario", "vamos", "training_module_3_menu_video", 1),
      fallbackTransition("training_module_3_minutario"),

      exactTransition("training_module_3_menu_video", "continuar", "training_module_4_intro", 1),
      exactTransition("training_module_3_menu_video", "continuemos", "training_module_4_intro", 2),
      fallbackTransition("training_module_3_menu_video"),

      exactTransition("training_module_4_intro", "continuar", "training_module_4_survey_intro", 1),
      fallbackTransition("training_module_4_intro"),

      exactTransition("training_module_4_survey_intro", "vamos", "training_module_4_survey_q1", 1),
      exactTransition("training_module_4_survey_intro", "continuar", "training_module_4_survey_q1", 2),
      fallbackTransition("training_module_4_survey_intro"),

      exactTransition("training_module_4_survey_q1", "1", "training_module_4_survey_q2", 1, "1"),
      exactTransition("training_module_4_survey_q1", "2", "training_module_4_survey_q2", 2, "2"),
      exactTransition("training_module_4_survey_q1", "3", "training_module_4_survey_q2", 3, "3"),
      exactTransition("training_module_4_survey_q1", "4", "training_module_4_survey_q2", 4, "4"),
      exactTransition("training_module_4_survey_q1", "5", "training_module_4_survey_q2", 5, "5"),
      fallbackTransition("training_module_4_survey_q1"),

      exactTransition("training_module_4_survey_q2", "1", "training_module_4_survey_q3", 1, "1"),
      exactTransition("training_module_4_survey_q2", "2", "training_module_4_survey_q3", 2, "2"),
      exactTransition("training_module_4_survey_q2", "3", "training_module_4_survey_q3", 3, "3"),
      exactTransition("training_module_4_survey_q2", "4", "training_module_4_survey_q3", 4, "4"),
      exactTransition("training_module_4_survey_q2", "5", "training_module_4_survey_q3", 5, "5"),
      fallbackTransition("training_module_4_survey_q2"),

      exactTransition("training_module_4_survey_q3", "1", "training_module_4_survey_q4", 1, "1"),
      exactTransition("training_module_4_survey_q3", "2", "training_module_4_survey_q4", 2, "2"),
      exactTransition("training_module_4_survey_q3", "3", "training_module_4_survey_q4", 3, "3"),
      exactTransition("training_module_4_survey_q3", "4", "training_module_4_survey_q4", 4, "4"),
      exactTransition("training_module_4_survey_q3", "5", "training_module_4_survey_q4", 5, "5"),
      fallbackTransition("training_module_4_survey_q3"),

      exactTransition("training_module_4_survey_q4", "1", "training_module_4_survey_q5", 1, "1"),
      exactTransition("training_module_4_survey_q4", "2", "training_module_4_survey_q5", 2, "2"),
      exactTransition("training_module_4_survey_q4", "3", "training_module_4_survey_q5", 3, "3"),
      exactTransition("training_module_4_survey_q4", "4", "training_module_4_survey_q5", 4, "4"),
      exactTransition("training_module_4_survey_q4", "5", "training_module_4_survey_q5", 5, "5"),
      fallbackTransition("training_module_4_survey_q4"),

      exactTransition("training_module_4_survey_q5", "1", "training_module_4_survey_q6", 1, "1"),
      exactTransition("training_module_4_survey_q5", "2", "training_module_4_survey_q6", 2, "2"),
      exactTransition("training_module_4_survey_q5", "3", "training_module_4_survey_q6", 3, "3"),
      exactTransition("training_module_4_survey_q5", "4", "training_module_4_survey_q6", 4, "4"),
      exactTransition("training_module_4_survey_q5", "5", "training_module_4_survey_q6", 5, "5"),
      fallbackTransition("training_module_4_survey_q5"),

      exactTransition("training_module_4_survey_q6", "1", "training_module_4_completion", 1, "1"),
      exactTransition("training_module_4_survey_q6", "2", "training_module_4_completion", 2, "2"),
      exactTransition("training_module_4_survey_q6", "3", "training_module_4_completion", 3, "3"),
      exactTransition("training_module_4_survey_q6", "4", "training_module_4_completion", 4, "4"),
      exactTransition("training_module_4_survey_q6", "5", "training_module_4_completion", 5, "5"),
...
const nutriCourseModules: SeedCourseModule[] = [
  {
    ...
    summary: "Onboarding inicial, instrucciones del chat y preparacion para comenzar la capacitacion.",
    stepKeys: ["training_welcome_intro", "training_materials_intro"],
  },
  {
    slug: "modulo-1",
    title: "Modulo 1 - Verificacion de condiciones",
    summary: "Conceptos base, higiene, limpieza, contaminacion y evaluacion del modulo 1.",
    stepKeys: [
  ...
  },
  {
    ...
    summary: "Higiene personal, lavado de manos, residuos, PEPS, almacenamiento y control de plagas.",
    stepKeys: [
  ...
  },
  {
    ...
    summary: "Etiquetado, manual oficial, alimentacion saludable, preparacion de alimentos y menus.",
    stepKeys: [
  ...
  },
  {
    ...
    summary: "Cierre de la capacitacion, oferta alimentaria y encuesta final de satisfaccion.",
    stepKeys: [
